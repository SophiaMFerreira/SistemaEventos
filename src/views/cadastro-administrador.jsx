...
function CadastroAdministrador() {
  ...
  async function save(e) {
    ...
    console.log("4 - Criou objeto data", data);

    try {
      console.log("5 - Antes da validação");
      ...
      console.log("6 - Resultado validação:", valido);

      if (!valido) {
        console.log("7 - Validação bloqueou");
        return;
      }

      console.log("8 - Antes do POST");

      await axios.post(baseURL, data);

      console.log("9 - POST executado");

      mensagemSucesso("Administrador criado");
      navigate(`/`);
    } catch (error) {
      console.log("10 - Caiu no catch");
